...
Exposes a WebSocket protocol via WS standard or Socket.IO for CDS services. Runs in context of the [SAP Cloud Application Programming Model (CAP)](https://cap.cloud.sap/docs/) using CDS Node.js module [@sap/cds](https://www.npmjs.com/package/@sap/cds)
